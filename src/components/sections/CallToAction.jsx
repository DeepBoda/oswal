      ...
      <div className="container mil-p-60-30">
        <div className="row align-items-center">
          <div className="col-lg-9 mil-mb-30">
            <h4 className="mil-buttons-space mil-text-color">{Data.title}</h4>
          </div>
          <div className="col-lg-3 mil-mb-30">
            <Link
              href={Data.button.link}
              className="mil-float-right mil-button-border-radius-5 mil-button mil-button-md mil-button-dt-95 mil-scale-down-trigger mil-accent-trigger"
            >
