  ...
  return (
    <footer className="mil-footer-1 mil-light-trigger">
      ...
      <div className="container">
        <div className="mil-footer-content mil-p-60-50">
          <div className="row justify-content-between">
            <div className="col-lg-6 col-xl-4 mil-mb-30">
              <img src={appData.footer.logo.image} width={140} />
            ...
            <div className="col-lg-12 col-xl-8">
              <div className="row justify-content-xl-end">
                <div className="col-lg-3 col-xl-3 mil-mb-30">
                ...
                <div className="col-lg-4 col-xl-4 mil-mb-30">
                  <h6 className="mil-light mil-mb-30">Business Hours</h6>
                  <ul>
                    {Object.entries(appData.contacts.businessHours).map(
                      ([day, hours]) => (
                        <li
                          key={day}
                          style={{
                ...
                <div className="col-lg-4 col-xl-4 mil-mb-30">
                  ...
                  <a
                    ...
                    className="mil-link mil-link-hover mil-accent mil-hidden-trigger mil-mb-20"
                  >
                    {appData.contacts.email}
                  </a>
                  <a
                    href={`mailto:${appData.contacts.email2}`}
                    className="mil-link mil-link-hover mil-accent mil-hidden-trigger mil-mb-30"
                  >
                    {appData.contacts.email2}
                  </a>
                  {/* phone */}
