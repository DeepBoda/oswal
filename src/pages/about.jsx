...
const About = (props) => {
  ...
  const Content = {
    about1: {
      subtitle: "About Us",
      title: "Premium Sanitaryware Supplier",
      text_1:
        "Oswal: Gujarat's Leading Ceramics Innovator. Specializing in top-tier construction ceramics, we prioritize quality, innovation, and customer satisfaction. ISO 9001:2000 certified, we excel in advanced manufacturing, design, and technology to lead the industry.",
      text_2:
    ...
    about2: {
      subtitle: "About Us",
      accent: "Special Quality",
      title: " for<br/> Special People",
      text: "Best Ceramic Sanitary Ware - Elevate Your Home with Unmatched Quality and Style",
      text_1:
  ...
  return (
    <Layouts>
      {/* <PageBanner pageImage={"img/content/2.png"} pageTitle={"About 2"} /> */}
      <div style={{ position: "relative" }}>
        <img
          ...
          data-value-2="1.2"
        />
        <p className="custom-mil-text-banner">{Content.about1.subtitle}</p>
      </div>
      {/* <div className="mil-spacer-150" /> */}
      {/* about */}
        ...
        <div className="row justify-content-between">
          <div className="col-lg-5">
            ...
            <h3 className="mil-light mil-mb-30">
              <span className="mil-accent">{Content.about2.accent}</span>
              <span
                dangerouslySetInnerHTML={{ __html: Content.about2.title }}
              />
            </h3>
          ...
          <div className="col-lg-6">
            <div className="row">
              <p className="mil-appearance mil-mb-30">{Content.about2.text}</p>
              {/* <div className="col-lg-6">
