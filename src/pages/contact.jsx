...
const Contact = () => {
  ...
  return (
    <Layouts>
          ...
          <div className="col-xl-6">
            <div className="row mil-mt-55-adapt">
              {Content.info.map((item, key) => (
                <div className="col-lg-8" key={`contact-item-${key}`}>
                  <div className="mil-icon-box mil-box-hori mil-appearance mil-mb-30">
                    ...
                    <div className="mil-icon-box-text">
                      ...
                      {item.value2 ? (
                        <a href={`mailto:${item.value2}`} className="">
                          {" "}
                          <h6>{item.value2}</h6>
                        </a>
                      ) : null}
      ...
      {/* contact end */}
      {/* @22.5730734,71.2047509,17z */}
      {/* 22.5963799,71.1952423 */}
      {/* map */}
      <div className="mil-map-frame">
        <iframe
          src={
            "https://maps.google.com/?q=22.5963799,71.1952423&ie=UTF8&iwloc=&output=embed"
          }
          // src={`https://maps.google.com/maps?q=22.5730734,71.2047509&hl=es;z=17&amp;output=embed`}
