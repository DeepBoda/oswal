    ...
    <Layouts>
      ...
      {/* <div style={{ position: "relative" }}>
        <img
          ...
          data-value-2="1.2"
        />
        <p className="custom-mil-text-banner">{postData.title}</p>
      </div> */}
        ...
        <Gallery>
          <div className="row justify-content-center">
            <div className="col-lg-12 col-xl-9 mil-content-frame mil-appearance mil-p-120-0">
              ...
              <div className="mil-divider mil-appearance "></div>
                      ...
                      {postData.gallery.items.map((item, key) => (
                        ...
                        >
                          ...
                          <div
                            className={
                              postData.gallery.style == "vertical"
                                ? "mil-appearance mil-just-image mil-image-vert  "
                                : "mil-appearance mil-just-image mil-image-hori  "
                            }
                          >
                            <img
                              src={item.image}
                          ...
                          <div
                            className="mil-item-description "
                            style={{
                              marginTop: "5px",
                              marginBottom: "25px",
                              display: "flex",
                          ...
                          >
                            <div className="mil-text-bg mil-mb-5">
                              <h5 className="mil-light">{item.alt}</h5>
                            </div>
                          </div>
                          {/* </a>
                            )}
